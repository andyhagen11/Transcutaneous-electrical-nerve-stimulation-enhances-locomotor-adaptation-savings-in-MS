...
#For demographic variables
  #formula = "EarlyADSave_SLA ~ Group + Condition + Gender + Age + FastLeg + EOFirm + ECFirm + EOFoam + ECFoam + Composite + SymbolDigit + CombinedVT + Avg_StepLength_B + StepLengthAsym_Normalized_B + BMI + RPE + Activity"
